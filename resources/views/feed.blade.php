                ...
                @if ($reclamacao->denunciada == 0)
                    <div class="media text-muted px-md-2 pt-3">
                        ...
                        <p class="media-body pb-3 small mb-0 lh-125 border-bottom border-gray">
                            ...
                            <a href="{{route('reclamar.storeThumbsUp', ['id' => $reclamacao->id , 'idUsuario' => Auth::user()->id])}}"
                               class="btnThumbsUpIcon col-2" aria-haspopup="false" aria-expanded="false">
